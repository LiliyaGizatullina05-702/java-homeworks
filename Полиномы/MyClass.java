public class MyClass { 
 public static void main(String[] args) { 
   ...
   Polynom polynomMultToNumber = Polynom.polynomMultToNumber(polynom1, 0.5);

   System.out.println("Multiplication to number: " + polynomMultToNumber);

   Polynom polynomMultiplication = Polynom.polynomMultiplication(polynom1, polynom2);

   System.out.println("Multiplication: " + polynomMultiplication);
 } 
